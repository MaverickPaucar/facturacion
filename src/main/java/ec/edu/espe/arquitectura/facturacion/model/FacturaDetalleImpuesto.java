...
public class FacturaDetalleImpuesto {
    ...
    @Column(name = "COD_FACTURA_DETALLE_IMPUESTO", nullable = false)
    ...
    private Integer codigoFacturaDetalle;
    ...
    @ManyToOne
    @JoinColumn(name = "COD_FACTURA_DETALLE", referencedColumnName = "COD_FACTURA_DETALLE", insertable = false, updatable = false)
    private FacturaDetalle facturaDetalle;

    public FacturaDetalleImpuesto() {
    }

    public FacturaDetalleImpuesto(Integer codigo) {
        this.codigo = codigo;
    }
    ...
    public Integer getCodigoFacturaDetalle() {
        return codigoFacturaDetalle;
    }

    public void setCodigoFacturaDetalle(Integer codigoFacturaDetalle) {
    ...
    public String toString() {
        return "FacturaDetalleImpuesto [codigo=" + codigo + ", codigoImpuesto=" + codigoImpuesto + ", porcentaje="
                + porcentaje + ", codigoFacturaDetalle=" + codigoFacturaDetalle + ", valor=" + valor + ", version="
                + version + ", impuestoPorcentaje=" + impuestoPorcentaje + ", facturaDetalle=" + facturaDetalle + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        FacturaDetalleImpuesto other = (FacturaDetalleImpuesto) obj;
        if (codigo == null) {
